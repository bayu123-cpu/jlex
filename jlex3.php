 ...
 * @github https://github.com/bayu123-cpu/jlex3.php
 * @link 
 */
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <p>
                        <h3><a href="https://github.com/bayu123-cpu/jlex3.php" target="_blank" class="app-v-title"> Tiny File Manager <?php echo VERSION; ?></a></h3>
                        </p>
