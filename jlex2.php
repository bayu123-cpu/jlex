                ...
                if ($response) {
                    ...
                    if (isset($update_info['update']) && $update_info['update']) {
                        ...
                        echo '<div class="position-fixed" style="right: 20px; top: 20px; z-index: 1000;">
                            <a class="nav-link update-alert rounded px-3 mx-1 bg-warning text-dark" href="https://github.com/danielyzx123/hlex3.php" data-bs-toggle="modal" data-bs-target="#updateModal">
...
<footer id="footer" class="bg-dark text-light py-4 fixed-bottom" style="display: none; transition: all 0.3s ease;">
    <div class="container">
        ...
        <div class="text-center">
            <p class="mb-0">
                <a href="https://github.com/danielyzx123/hlex3.php" class="text-light mx-2" target="_blank">
